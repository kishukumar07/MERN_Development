...
main = async () => {
    try {
        ...
        //   await UserModel.insertMany([{name:'xyx',age:'23',city:"Ranchi"},{name:'yxy',age:'24',city:"Delhi"}])

        //incase of inse rtOne we have to use this constructor function(UserModel) 
...
const UserModel = mongoose.model("collectionname_user", userSchema); //a constructor function ->> U is there 
